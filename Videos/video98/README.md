...
In this video, 
 ...
 - Review the capabilities of the device.
 - Discuss the Test Rig and configuration.
 - Discusss the three makers and their GitHub site information.

The code for this video is available at the GitHub site:
https://github.com/kwinter745321/myHA/tree/main/Videos/video98

# Files

 - YAML

 This YAML requires 2026.06.1 or newer.

 - #3D-files

 This file was exported as a STL file from source created in FreeCAD 0.21