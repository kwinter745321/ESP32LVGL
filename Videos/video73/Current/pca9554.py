...
class Pca9554(object):
    ...
    def read_input_register(self):
        ...
        try:
            ...
            return self.i2c_bus.readfrom(self.i2c_address, IN_REG)
        except:
            return None
    ...
    def read_output_register(self):
        ...
        try:
            ...
            return self.i2c_bus.readfrom(self.i2c_address, OUT_REG)
        except:
            return None
    ...
    def read_polarity_inversion_register(self):
        ...
        try:
            ...
            return self.i2c_bus.readfrom(self.i2c_address, POL_REG)
        except:
            return None
    ...
    def read_config_register(self):
        ...
        try:
            ...
            return self.i2c_bus.readfrom(self.i2c_address, CONF_REG)
        except:
            return None
    ...
    def read_port(self, port_num):
        ...
        try:
            ...
            line_value = self.i2c_bus.readfrom(self.i2c_address, IN_REG)
    ...
    def write_port(self, port_num, state):
        ...
        try:
            ...
            current_value = self.i2c_bus.readfrom(self.i2c_address, OUT_REG)
            if state:
            ...
            self.i2c_bus.writeto(self.i2c_address, OUT_REG, new_value)
            return True
        except:
            return False
    ...
    def write_output_register(self, value):
        ...
        try:
            ...
            self.i2c_bus.writeto(self.i2c_address, OUT_REG, value)
            return True
        except:
            return False
    ...
    def write_polarity_inversion_register(self, value):
        ...
        try:
            ...
            self.i2c_bus.writeto(self.i2c_address, POL_REG, value)
            return True
        except:
            return False
    ...
    def write_config_register(self, value):
        ...
        try:
            ...
            self.i2c_bus.writeto(self.i2c_address, CONF_REG, value)
            return True
        except:
            return False
    ...
    def write_config_port(self, port_num, state):
        ...
        try:
            ...
            current_value = self.i2c_bus.readfrom(self.i2c_address, CONF_REG)
            if state:
                new_value = current_value | 1 << port_num
            else:
                new_value = current_value & (255 - (1 << port_num))
            #self.i2c_bus.write_byte_data(self.i2c_address, CONF_REG, new_value)
            self.i2c_bus.writeto(self.i2c_address, CONF_REG, new_value)
            return True
        except:
            return False
