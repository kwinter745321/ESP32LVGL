...
#disp = ili9xxx.Ili9488b(spi=spi, dc=4, cs=10, rst=5, rot=0)
# 3.5 inch ILI9488 Capacitive touch
#disp.write_register(0x21, b"\x00")

disp = ili9xxx.St7796(spi=spi, dc=4, cs=10, rst=5, rot=0)
...
if disp.display_type in ['ili9488','ili9488b' ,'st7796']:
    touch = xpt2046.Xpt2046_hw(spi=tspi,cs=17,width=(320),height=(480),rot=disp.rot)
elif disp.display_type in ['ili9341', 'st7789']:
    touch = xpt2046.Xpt2046_hw(spi=tspi,cs=17,width=(240),height=(320),rot=disp.rot)
else:
