...
from machine import Pin, SPI, SoftSPI  # type: ignore
import gc
...
def test():
    ...
    #s3
    #spi = SoftSPI(baudrate=80_000_000, sck=Pin(12), mosi=Pin(11), miso=Pin(13) )
    #display = Display(spi, dc=Pin(7), cs=Pin(10), rst=Pin(4))
    ...
    sleep(1)
    get = input("Press Enter Key to Exit")
    display.cleanup()
